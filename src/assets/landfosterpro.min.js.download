...
(function ($) {
    ...
    var lfproSticky = function ($scope, $) {
    var lfproStickySection = $scope.find('.lfpro-sticky-section-yes').eq(0);

    lfproStickySection.each(function(i) {
        var dataSettings = $(this).data('settings');
        $.each( dataSettings, function(index, value) { 
            if( index === 'lfpro_sticky_top_spacing' ){
                $scope.find('.lfpro-sticky-section-yes').css( "top", value + "px" );
            }
        }); 
    });
    ...
    if ( lfproStickySection.length > 0 ) {
        var parent = document.querySelector('.lfpro-sticky-section-yes').parentElement;
        while (parent) {
    ...
    var columnClass = $scope.find( '.lfpro-column-sticky' );
    ...
    if( dataType === 'column' ){
        ...
        $(window).on('elementor/frontend/init', function () {
            ...
            elementorFrontend.hooks.addAction( 'frontend/element_ready/section', lfproSticky);
        }); 
